...
document.write('<script type="text/javascript" src="client/vendor/jquery/v3.1.0/jquery.min.js?version=' + social_bpm_widget_version + '"></script>');
document.write('<script type="text/javascript" src="client/vendor/jquery-ui/v1.12.0/jquery-ui.min.js?version=' + social_bpm_widget_version + '"></script>');
